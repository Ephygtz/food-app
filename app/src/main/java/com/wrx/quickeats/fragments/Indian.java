...
public class Indian extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_indian, container, false);


        rv_indian_menu=(RecyclerView)view.findViewById(R.id.rv_indian_menu);

        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());

        rv_indian_menu.setLayoutManager(linearLayoutManager);
        ...
        rv_indian_menu.setAdapter(menuAdapter);
