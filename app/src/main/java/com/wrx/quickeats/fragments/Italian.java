...
public class Italian extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_italian, container, false);



        rv_italian_menu=(RecyclerView) view.findViewById(R.id.rv_italian_menu);


        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());

        rv_italian_menu.setLayoutManager(linearLayoutManager);
        ...
        rv_italian_menu.setAdapter(menuAdapter);
